...
YOLOv5_ROOT = FILE.parents[1] / 'scripts/modules/yolov8-seg/yolo-V8'  # YOLOv8 root directory
if str(YOLOv5_ROOT) not in sys.path:
    sys.path.append(str(YOLOv5_ROOT))  # add YOLOv8_ROOT to PATH
# print(YOLOv5_ROOT)
        ...
        if results[0].masks is not None:
            ...
            for i in range(len(results[0].masks.data)):
                ...
                if max_white_pixels <= white_pixel_count:
                    ...
                    indices_with_max_white_pixels = indices
            ...
            if x_mean == -1 and y_mean == -1:
                ...
                indices = indices_with_max_white_pixels # find_element_indices(img_mask, 255)
