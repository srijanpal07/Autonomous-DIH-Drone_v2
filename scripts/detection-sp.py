...
half = False
max_delay = 0.5 # [seconds] delay between last detectiona and current image after which to just drop images to catch up
...
savedir = maindir.joinpath('%s/run%02d/detection' % (stamp,new_run_num))
os.makedirs(savedir) 
